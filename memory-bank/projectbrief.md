...
| Dirección ejecutiva | CEO (ver inconsistencias) | — |
...
- No inventar clientes, logos, certificaciones, premios ni cifras. Cifras permitidas: las que figuran en el
  CONTEXT (2009, ~130 empleados, 2 países, 2 almacenes, 8 transportistas, 18–25 % devoluciones, ~80 % consultas
  automatizables, tamaños de equipo).
...
## Inconsistencias conocidas del CONTEXT (no resolver por cuenta propia)

1. **Nombre del CEO:** `CONTEXT.es.md` dice “Thomas Harry, fundador y CEO” en un párrafo y “CEO: Daniel Espinoza”
   (y “Daniel ha creado TrackFlow Tech”) en otros. → No se muestra el nombre del CEO en ninguna UI. Pendiente de
   confirmar con el desarrollador/instructor.
2. **Claims de marketing vs. realidad técnica:** el briefing del Hito 1 pide copy como “inventario en tiempo real”
   y “tecnología propia para visibilidad total”, mientras `CONTEXT.es.md` indica que hoy los dos almacenes **no**
   comparten inventario. El website usa el copy del stakeholder, pero conviene que Miguel Torres lo revise.
