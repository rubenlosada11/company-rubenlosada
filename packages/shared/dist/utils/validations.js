const SHIPMENT_STATUSES = ["pending", "in_transit", "delivered", "delayed", "lost"];
const RETURN_REASONS = ["wrong_size", "defective", "not_as_described", "changed_mind", "other"];
const RETURN_STATUSES = ["pending_review", "approved", "rejected", "refurbished", "discarded"];
const PRODUCT_TYPES = ["moda", "electronica", "cosmetica", "alimentacion", "otro"];
const COUNTRY_CODES = ["US", "ES"];
...
export function validateReturnRequest(returnRequest) {
    const errors = [];
